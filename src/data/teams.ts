...
export const teams: Record<string, TeamMember[]> = {
  "Core Team": [
    ...
    { name: "Shrinidhi Dasraty", role: "Vice President", image: "/Core-team/Vice-president/Shrinidhi Dasraty.jpg", objectPosition: "50% 15%", scale: 1.2 },
    ...
    { name: "Naresh Anand S", role: "Joint Secretary", image: "/Core-team/Joint Sec/Naresh Anand S.jpg", objectPosition: "top" },
  ],
  "Executive Team": [
  ...
  "Web Team": [
    ...
    { name: "Diya S", role: "Web Team Member", image: "/WEB TEAM/Dhiya.png" },
    { name: "Sooraj D", role: "Web Team Member", image: "/WEB TEAM/Sooraj D.jpg", objectPosition: "top" },
  ...
  "Design Team": [
    ...
    { name: "Yogavarshini M", role: "Design Team Member", image: "/DESIGN TEAM/Yogavarshini M.jpeg", objectPosition: "top" },
  ],
  "Content Team": [
    ...
    { name: "R.Lekshita Pranavi", role: "Content Team Member", image: "/CONTENT TEAM/R.Lekshita Pranavi.jpeg", objectPosition: "top" },
    { name: "Sai Vignesh P", role: "Content Team Member", image: "/CONTENT TEAM/Sai Vignesh P.jpeg", objectPosition: "top" },
  ],
  "Marketting And Outreach Team": [
    ...
    { name: "Balaji B", role: "Marketting Team Member", image: "/MARKETING & OUTREACH TEAM/Balaji.B.jpeg" },
